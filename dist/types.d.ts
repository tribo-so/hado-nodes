...
import { z } from "zod";
import { zAllProperties, zComboboxProperty, zCredentialMeta, zDynamicOptions, zNodeMeta, zNodeOperation, zSectionProperty, zSelectOption } from "./schemas";
...
export interface Node {
    ...
    run(ctx: RunContext, cmd: Commands): any;
...
export interface Commands {
    halt: () => Commands;
    resume: (data: ResumeNodeDto, options?: {
        delay_ms?: number;
    }) => Commands;
